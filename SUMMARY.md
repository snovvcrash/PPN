...
* [Infrastructure](pentest/infrastructure/README.md)
  - [AD](pentest/infrastructure/ad/README.md)
    ...
    * [AD CS Abuse](pentest/infrastructure/ad/ad-cs-abuse/README.md)
      ...
      - [Pass-the-Certificate](pentest/infrastructure/ad/ad-cs-abuse/ptc.md)
    ...
    * [Credentials Harvesting](pentest/infrastructure/ad/credential-harvesting/README.md)
      ...
      - [Windows Hello](pentest/infrastructure/ad/credential-harvesting/windows-hello.md)
    ...
    * [gMSA / dMSA](pentest/infrastructure/ad/gmsa-dmsa.md)
    ...
    * [Lateral Movement](pentest/infrastructure/ad/lateral-movement/README.md)
      - [DCOM](pentest/infrastructure/ad/lateral-movement/dcom.md)
  ...
  - [Azure AD](pentest/infrastructure/azure-ad/README.md)
    * [On-Prem ↔ Cloud](pentest/infrastructure/azure-ad/on-prem-cloud/README.md)
      - [Cloud → On-Prem](pentest/infrastructure/azure-ad/on-prem-cloud/cloud-on-prem.md)
      - [On-Prem → Cloud](pentest/infrastructure/azure-ad/on-prem-cloud/on-prem-cloud.md)
    * [PRT Abuse](pentest/infrastructure/azure-ad/prt-abuse.md)
  ...
  - [Pivoting](pentest/infrastructure/pivoting-tunneling.md)
...
* [Development](redteam/dev/README.md)
  - [API Hashing](redteam/dev/api-hashing.md)
  - [API Hooking](redteam/dev/api-hooking.md)
  - [BOF / COFF](redteam/dev/bof-coff.md)
  - [CFG](redteam/dev/cfg.md)
  - [Code Injection](redteam/dev/code-injection/README.md)
    * [DLL Injectors](redteam/dev/code-injection/dll-injectors.md)
    * [Process Hollowing](redteam/dev/code-injection/process-hollowing.md)
  - [DLL Hijacking](redteam/dev/dll-hijacking.md)
  - [Golang](redteam/dev/golang.md)
  - [Kernel Mode](redteam/dev/kernel-mode.md)
  - [PIC / Shellcode](redteam/dev/pic-shellcode.md)
  - [Nim](redteam/dev/nim.md)
  - [Sandbox Evasion](redteam/dev/sandbox-evasion.md)
  - [Syscalls](redteam/dev/syscalls.md)
  - [Windows API](redteam/dev/winapi.md)
